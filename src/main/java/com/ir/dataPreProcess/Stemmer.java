...
/**
 * source:
 * https://github.com/YFGu0618/trec-ir/blob/6bbf7d3d3e30697b5d05e71b202069feec1d8f4c/src/Classes/Stemmer.java
 */

/**
 * Implement stemmer based on the Porter Stemming Algorithm
 *
 * The Stemmer class transforms a word into its root form.
 * The input word can be provided a character at time (by calling add()),
 * or at once by calling one of the various stem(something) methods.
 */
public class Stemmer {
    private char[] b;
    private int i; // offset into b
    private int i_end; // offset to end stemmed word
    private int j, k;
     ...
     */
    public void add(char[] word, int wLen){
        if (i + wLen >= b.length){
